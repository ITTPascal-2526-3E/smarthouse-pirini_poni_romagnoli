...
namespace BlaisePascal.SmartHouse.Domain.Heating.HeatingDevices
{
    ...
    public sealed class HeatPump : Device, ITemperatureControl, IProgrammable
    {
        ...
        public HeatPump(Temperature initialTemperature, string name = "Unnamed HeatPump", string brand = "Generic", string model = "ModelX", EnergyClass energyEfficiency = EnergyClass.A)
